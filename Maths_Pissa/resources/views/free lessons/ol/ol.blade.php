...
<head>
    ...
    <title>O/L Pastpaper | Mathspissa</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <header class="page-header">
        <h1 class="page-title">Past Paper Discussions</h1>
        <p class="page-subtitle">පසුගිය විභාග ප්‍රශ්න පත්‍ර සහ ඒවා සාකච්චාව</p>
    </header>
    ...
    <div class="main-container">
        <!-- SIDEBAR -->
        <aside class="sidebar">
            <h2 class="sidebar-title">📄Paper</h2>
            <ul class="lesson-nav-list">
                <li class="lesson-nav-item">
                    <a href="#lesson-1" class="lesson-nav-link">2025</a>
                </li>
                <li class="lesson-nav-item">
                    <a href="#lesson-2" class="lesson-nav-link">2024</a>
                </li>
                <li class="lesson-nav-item">
                    <a href="#lesson-3" class="lesson-nav-link">2023</a>
                </li>
                <li class="lesson-nav-item">
                    <a href="#lesson-4" class="lesson-nav-link">2022</a>
                </li>
                <li class="lesson-nav-item">
                    <a href="#lesson-5" class="lesson-nav-link">2021</a>
                </li>
                <li class="lesson-nav-item">
                    <a href="#lesson-6" class="lesson-nav-link">2020</a>
                </li>
            </ul>
        </aside>
